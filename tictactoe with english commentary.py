...
def interactions(game_board):  # step by step interactions of the game  
    player_turn = True
    while True:
        ...
        if position_choice in positions: # loop that checks whethher or not there is a victory at each turn , depending on the player's positioning choices 
...
interactions(game_board) # playing of the game  